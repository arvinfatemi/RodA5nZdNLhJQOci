...
async def lifespan(app: FastAPI):
    ...
    # Start the trading bot scheduler automatically
    try:
        await scheduler_service.start_scheduler(interval_minutes=30)
        logger.info("Trading bot scheduler started successfully")
    except Exception as e:
        logger.error(f"Failed to start trading bot scheduler: {e}")
    ...
    try:
        ...
        logger.info("Trading bot scheduler stopped successfully")
    except Exception as e:
